...
function DailyTrend({ days }: Props) {
  ...
  return (
    <div className="bg-white border border-rule rounded-xl p-6">
      <h2 className="text-ink text-sm font-medium mb-1">30-day trend</h2>
      <p className="text-faint text-xs mb-4">Page views per day</p>
      {days.length === 0 ? (
          ...
          {days.map((d) => {
            ...
            return (
              <div
                ...
                className="flex-1 bg-accent rounded-sm hover:bg-accent-dark transition-colors cursor-default"
