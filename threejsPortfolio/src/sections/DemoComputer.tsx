...
const DemoComputer = (props: DemoComputerProps): JSX.Element => {
  ...
  const { nodes, materials, animations } = useGLTF('./src/public/models/computer.glb') as unknown as ComputerGLTF;
  const { actions } = useAnimations(animations, group);

  const txt = useVideoTexture(props.texture ? props.texture : './src/public/textures/project/project1.mp4');
