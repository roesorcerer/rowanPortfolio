...
const computer = 'https://57zrb2kcas.ufs.sh/f/LHwfoeNVr61ihL9aNVAeO1qwAJbS2in9KxsdPHvz53BGjfZu';

const video = 'https://57zrb2kcas.ufs.sh/f/LHwfoeNVr61iLTYlh4NVr61iBEq8NPvKn3YUD5kGmTcM2ylF';


// Define types for the GLTF result
interface ComputerGLTF {
  nodes: {
...
const DemoComputer = (props: DemoComputerProps): JSX.Element => {
  const group = useRef<Object3D>(null);
  const { nodes, materials, animations } = useGLTF(computer) as unknown as ComputerGLTF;
  const { actions } = useAnimations(animations, group);

  const [videoTexture, setVideoTexture] = useState<THREE.VideoTexture | null>(null);

    // Use custom video texture loading
    useEffect(() => {
      const videoElement = document.createElement('video');
      videoElement.crossOrigin = 'anonymous';
      videoElement.loop = true;
      videoElement.muted = true;
      videoElement.src = props.texture || video;
